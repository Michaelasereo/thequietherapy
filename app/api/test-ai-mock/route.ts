...
import { generateSOAPNotes } from '@/lib/ai-services-mock'
...
export async function GET() {
  try {
    ...
    console.log('Testing Mock AI SOAP notes generation...')
    ...
    console.error('Mock AI test error:', error)
    return NextResponse.json({
      success: false,
      error: 'Mock AI API test failed',
