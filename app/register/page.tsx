...
function RegisterContent() {
  ...
  const [error, setError] = useState(redirectError === 'account_not_found' ? 'Account not found. Please sign up to create your account.' : '')
      ...
      <div className="flex-1 lg:w-3/5 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            {userType !== 'individual' && (
              <p className="text-sm text-gray-600 mt-1">{getUserTypeLabel()} Registration</p>
            )}
          </div>
