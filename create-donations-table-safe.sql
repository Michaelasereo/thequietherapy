-- Safe donations table creation script
...
-- Create donations table (will not error if already exists)
...
-- Create indexes for faster queries (will not error if already exist)
...
SELECT COUNT(*) as current_donation_count FROM donations;
