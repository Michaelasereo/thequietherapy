...
WHERE email IN ('michael@opportunedesignco.com', 'skyegenius@gmail.com');
...
SELECT '✅ Therapists removed successfully!' as status,
       'Deleted: michael@opportunedesignco.com, skyegenius@gmail.com' as details;
